 ...
 ******************************************************************************
 */
static void hal_write( uint8_t *buffer, uint16_t count);
static void hal_read(uint8_t *buffer, uint16_t count);
//static void hal_write_then_read( uint8_t *write_buffer, uint16_t write_count, uint8_t *read_buffer, uint16_t read_count);
/*!
 ******************************************************************************
 ...
 ******************************************************************************
 */
static void st25r3916comTx( uint8_t* txBuf, uint16_t txLen, bool last, bool txOnly );
...
/*******************************************************************************/
ReturnCode st25r3916WriteMultipleRegisters( uint8_t reg, uint8_t* values, uint8_t length )
{
    if( length > 0U )
    {
        st25r3916comStart();
...
/*******************************************************************************/
ReturnCode st25r3916WriteFifo( uint8_t* values, uint16_t length )
{
...
/*******************************************************************************/
ReturnCode st25r3916WritePTMem(  uint8_t* values, uint16_t length )
{
...
/*******************************************************************************/
ReturnCode st25r3916WritePTMemF(  uint8_t* values, uint16_t length )
{
...
/*******************************************************************************/
ReturnCode st25r3916WritePTMemTSN(  uint8_t* values, uint16_t length )
{
...
static void hal_read(uint8_t *buffer, uint16_t count) 
{
    DRV_SPI_ReadTransferAdd(appData.handle, buffer, count, &appData.transferHandle);
    while (DRV_SPI_TransferStatusGet(appData.transferHandle) == DRV_SPI_TRANSFER_EVENT_PENDING);
//    vTaskDelay(1 / portTICK_PERIOD_MS);
}
...
//static void hal_write_then_read( uint8_t *write_buffer, uint16_t write_count, uint8_t *read_buffer, uint16_t read_count)
//{
//    hal_write(write_buffer,write_count);
//    vTaskDelay(0.0001 / portTICK_PERIOD_MS); //100ns     
//    hal_read(read_buffer,read_count);
////    vTaskDelay(1 / portTICK_PERIOD_MS);
//}